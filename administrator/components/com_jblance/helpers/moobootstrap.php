...
abstract class JHtmlMooBootstrap
{
	...
	public static function framework($debug = null)
	{
		...
		JHtml::_('script', 'administrator/components/com_jblance/helpers/bootstrap/js/moobootstrap.js');
	...
	public static function loadCss($includeMainCss = true, $direction = 'ltr', $attribs = array())
	{
		...
		if ($includeMainCss)
		{
			JHtml::_('stylesheet', 'administrator/components/com_jblance/helpers/bootstrap/css/bootstrap.css', $attribs, false);
			JHtml::_('stylesheet', 'administrator/components/com_jblance/helpers/bootstrap/css/bootstrap-responsive.css', $attribs, false);
		}
