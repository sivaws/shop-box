...
$css[] = sprintf('.wrapper { max-width: %dpx; }', $this['config']->get('template_width') + 20);
...
if ($this['config']->get('system_white') == 'white') $this['asset']->addFile('css', 'css:system-white.css');
...
$fonts = array(
	...
	'sourcesanspro' => 'template:fonts/sourcesanspro.css',
	'roboto' => 'template:fonts/roboto.css',
	'titilliumtext' => 'template:fonts/titilliumtext.css',
...
if ($body_config['style'] == 'polygon') {
	$this['asset']->addFile('js', 'js:animatedbg.js');
	$this['asset']->addFile('js', 'js:fss.min.js');
}
